...
impl Cpu {
    ...
    pub unsafe fn execute_inf(&mut self) -> Result<CpuStatus> {
        ...
        let block = self.translator.translate_blocks(insts);
...
mod tests {
    ...
    fn test_control_flow() {
        ...
        let mem = [
            ...
            0x00, 0xb9, 0xff, 0x03, 0x00, 0xf9, 0x01, 0x00, 0x00, 0x14, 0xe8, 0x03, 0x40, 0xf9,
            0x09, 0x20, 0x9c, 0xd2, 0xa9, 0xbe, 0xa0, 0xf2, 0x08, 0x01, 0x09, 0xeb, 0xe8, 0xb7,
            0x9f, 0x1a, 0x48, 0x01, 0x00, 0x37, 0x01, 0x00, 0x00, 0x14, 0xe8, 0x0b, 0x40, 0xb9,
            0x08, 0x05, 0x00, 0x11, 0xe8, 0x0b, 0x00, 0xb9, 0x01, 0x00, 0x00, 0x14, 0xe8, 0x03,
            0x40, 0xf9, 0x08, 0x05, 0x00, 0x91, 0xe8, 0x03, 0x00, 0xf9, 0xf2, 0xff, 0xff, 0x17,
            0xe0, 0x0b, 0x40, 0xb9, 0xff, 0x43, 0x00, 0x91, 0xc0, 0x03, 0x5f, 0xd6,
        ];
        ...
        *cpu.context.lr_mut() = 114514;
        ...
        loop {
            let _ = unsafe { cpu.execute::<32>().unwrap() };
